...
export const metadata: Metadata = {
  ...
  description:
    "Formación profesional NeoSer 2026: Neurobiología del Parto, Protocolos para un Nacimiento Humanizado, El Arte del Rebozo (virtual y programa semipresencial de 64 h), Antropología y Sociología del Nacimiento y la jornada Herramientas para un Nacimiento Humanizado.",
