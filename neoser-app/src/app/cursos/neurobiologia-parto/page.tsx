...
export const metadata: Metadata = {
  ...
  description:
    "Edición 2026 II. Curso virtual sincrónico que integra neurobiología, microbiota, epigenética, neurociencias y teoría del apego en protocolos clínicos basados en evidencia. 64 horas académicas (4 créditos), con el Dr. Beltrán Lares.",
